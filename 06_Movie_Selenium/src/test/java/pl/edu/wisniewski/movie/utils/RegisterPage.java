...
public class RegisterPage {
    public boolean registerpage(WebDriver driver) {
        Random rnd = new Random();
        int number = rnd.nextInt() * 456;
        int number2 = rnd.nextInt() * 21;
        ...
        driver.findElement(By.xpath("//*[@id='email_create']")).sendKeys("xxxx" + number + number2);
        ...
        driver.findElement(By.xpath("//*[@id='passwd']")).sendKeys("XXXX");
